...
extension Color {
    ...
    static var randomColor: Color {
        return colorList.randomElement() ?? .maroon
    }
    
    static func randomNColors(_ n: Int) -> [Color] {
    ...
    static let defaultColors: [Color] = [ .red, .green, .blue, .yellow, .orange, .purple, .brown, .cyan, .mint, .teal, .gray, .black]
    static let colorList: [Color] = [    .maroon,
                                  .darkRed,
                                  .brown1,
                                  .firebrick,
                                  .crimson,
